...
/**
 * Created by tho nguyen on 2019-05-02.
 */
public class ZoomableImageView extends ImageView {

    private MatrixChangedListener matrixChangedListener;
    private float fitScale;

    public void setMatrixChangedListener(MatrixChangedListener matrixChangeListener) {
        this.matrixChangedListener = matrixChangeListener;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //Fit to screen.
        fitScale = width > height ? height / bmHeight : width / bmWidth;

        matrix.setScale(fitScale, fitScale);
        saveScale = 1f;

        originalBitmapWidth = fitScale * bmWidth;
        originalBitmapHeight = fitScale * bmHeight;
    ...
    public void setImageMatrix(Matrix matrix) {
        ...
        if (matrixChangedListener != null) {
            matrixChangedListener.onImageMatrixChanged(matrix, fitScale);
        }

    }

    public interface MatrixChangedListener {
        void onImageMatrixChanged(Matrix matrix, float fitScale);
    }
}
